...
class Distance:
    ...
    def __init__(self, trigger_pin = 12, echo_pin = 13, echo_timeout_us=500*2*30):
        """
    ...
    def _send_pulse_and_wait(self):
        ...
        try:
            ...
            if pulse_time < 0:
                MAX_RANGE_IN_CM = const(500) # type: ignore # it's really ~400 but I've read people say they see it working up to ~460
